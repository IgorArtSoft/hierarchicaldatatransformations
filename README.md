...
Background details of “reading order in PDF documents” issue.
...
So for them it's critically important that the information from PDF file must be in logical reading order.
PDF file could be a bank statement, or a bill from an online order or any government-issued document, which requires further action. And what if a self-isolated person with poor vision gets this document? He can’t read it. A speech reader program on his/her computer could read PDF file out loud.
Let’s look realistically into the near future. Coronavirus will not disappear soon.
So to prevent the virus spread, many people will rely more on online government, banking, insurance, and financial sector activities. 
Ability to hear the content of a file, while doing something else, is a very convenient time saver for everyone.
